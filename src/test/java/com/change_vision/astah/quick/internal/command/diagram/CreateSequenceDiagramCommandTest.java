...
import com.change_vision.astah.quick.internal.command.diagram.CreateSequenceDiagramCommand.SequenceDiagramCandidate;
import com.change_vision.jude.api.inf.model.INamedElement;


public class CreateSequenceDiagramCommandTest {
    
    private CreateSequenceDiagramCommand command;
    ...
    @Mock
    public SequenceDiagramCandidate diagramCandidate;

    @Before
    public void before() throws Exception {
        MockitoAnnotations.initMocks(this);
        command = new CreateSequenceDiagramCommand();
        command.setApi(api);
    ...
    public  void executeWithCorrectCandidate() throws Exception {
        ...
        verify(api).createSequenceDiagram(element, "hoge");
    }
