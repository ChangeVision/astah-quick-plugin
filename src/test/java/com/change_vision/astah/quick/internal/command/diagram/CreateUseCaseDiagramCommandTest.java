...
import com.change_vision.astah.quick.internal.command.diagram.CreateUseCaseDiagramCommand.UseCaseDiagramCandidate;
import com.change_vision.jude.api.inf.model.INamedElement;


public class CreateUseCaseDiagramCommandTest {
    
    private CreateUseCaseDiagramCommand command;
    ...
    @Mock
    public UseCaseDiagramCandidate diagramCandidate;

    @Before
    public void before() throws Exception {
        MockitoAnnotations.initMocks(this);
        command = new CreateUseCaseDiagramCommand();
        command.setApi(api);
    ...
    public  void executeWithCorrectCandidate() throws Exception {
        ...
        verify(api).createUseCaseDiagram(element, "hoge");
    }
